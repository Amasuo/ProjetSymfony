 ...
 */
final class Version20200329193625 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appointment CHANGE doctor_id doctor_id INT DEFAULT NULL, CHANGE date date DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appointment CHANGE doctor_id doctor_id INT DEFAULT NULL, CHANGE date date DATE NOT NULL');
