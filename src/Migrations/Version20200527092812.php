 ...
 */
final class Version20200527092812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD img VARCHAR(255) DEFAULT NULL, CHANGE nb_comments nb_comments INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post DROP img, CHANGE nb_comments nb_comments INT DEFAULT NULL');
